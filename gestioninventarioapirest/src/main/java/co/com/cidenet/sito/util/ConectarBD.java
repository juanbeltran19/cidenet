...
/**
 * Esta clase permite conectar a una base de datos Mysql, acces y ademas
...
final public class ConectarBD {
	...
	public ConectarBD(String nombreBD, String usuario, String password) throws Exception {

		configurarConexion(nombreBD, usuario, password);
	...
	public void configurarConexion(String nombreBD, String usuario, String password) throws Exception {
		...
		String url = "jdbc:h2:mem:" + nombreBD;
		...
		sentencia = conexion.createStatement();// createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,
	...
	public void ejecutaSentencia(String sentenciaSQL) throws Exception {
		...
		// Se valida de que se halla configurado las auditorias y se general las
		// auditorias
		if (generarAuditorias) {
			...
			StringBuffer sentenciaSQLAuditoria = new StringBuffer(
					"Insert Into AuditoriasTransacciones values(null,'" + nombreUsuario + "','" + fechaServidor + "','"
							+ nombreTerminal + "','" + tabla + "','" + tipoSentencia + "','" + sentenciaSQL + "')");
	 ...
	 * @param campos      Array de los nombres de los valores (datos) a almecenar en
	 *                    un tabla en la BD
	 * @param conMySQL    Conexion de la Base de datos
	 * @param escribir    true si desea mostrar mensajes desde el metodo; false en
	 *                    caso contrario
	 *
	 */
	 ...
	 *
	 * @param nombreTabla Nombre de la tabla a actualizar
	 * @param array       Array de los nombres de los valores (datos) a almecenar en
	 *                    un tabla en la BD
	 * @param conMySQL    Conexion de la Base de datos
	 * @param escribir    true si desea mostrar mensajes desde el metodo; false en
	 *                    caso contrario
	 *
	 */
	final public boolean guardar(String nombreTabla, String[][] array, int numColumnas, boolean escribir)
			throws Exception {
	 ...
	 * @param nombreTabla Nombre de la tabla a actualizar
	 * @param campos      Array de los nombres de los valores (datos) a almecenar en
	 *                    un tabla en la BD return String senetencia de insercion de
	 *                    datos
	 *
	 */
	 ...
	 * @param tipo    Tipo de mensaje: 0 error, 1 Informacion o confirmacion, 2
	 *                Precaucion
	 *
	 */
	...
	public boolean validarRegistro(String nombreTabla, String condicion) {
		...
		try {
			String sentenciaSQL = "Select 'x' " + "From " + nombreTabla + " " + condicion;
